package numberPrograms.numberToWord;
...
public class NumberToWordExample2 {
	...
	//user-defined method that converts a number to words(up tp 1000)
	...
	//user-defined method that converts a long number(0 to 9999999999) to string
	public static String convertNumberToWord(long number) {
		...
		//the toString() methods returns a String object that represents the specified long 
		String num = Long.toString(number);

		//for creating a mask padding with "0"
		String pattern = "0000000000000";

		//creates a DecimalFormat using the specifed pattern and also provides the symbols for the default locale
		...
		//format: XXXnnnnnnnnn
		//the subSting method returns a new string that is a substring of this string
