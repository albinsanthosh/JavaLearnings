...
public class FileChooserMethodExample extends JFrame implements ActionListener{
	// declaring a Jlable to show the files whichare selected by the user
	static JLabel l;

	// a default constructor
	FileChooserMethodExample()  
    {  
    }
	...
	public static void main(String args[]) {
		...
		FileChooserMethodExample f1 = new FileChooserMethodExample();
